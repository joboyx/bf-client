    ...
    <div>
        <div v-if="user">
            ...
            <div v-if="user.tier === 1">
                ...
                <div class="title font-weight-thin text-xs-center justify-center mt-5">
                    End date: {{user.tier_end}}
                </div>
                <div class="caption font-weight-thin text-xs-center justify-center mt-5" v-if="user.patreon_connected">
                    You are a Patron.
                </div>
            ...
            <v-divider class="ma-5" v-if="!user.patreon_connected"></v-divider>
            <div v-if="!user.patreon_connected" class="title font-weight-thin text-xs-center justify-center mt-5">
