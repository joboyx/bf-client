    ...
    <v-card-title>
      ...
      ></v-text-field>
        ...
        <template v-slot:items="props">
            <td>
                <span v-if="props.item.change_type==='tag'" class="font-weight-black font-italic" style="text-decoration: ;">
                {{ props.item.tag }}                    
                </span>
                <span v-else>
                {{ props.item.tag }}
            ...
            <td class="text-xs-centre">
                <span v-if="props.item.change_type==='description'" class="font-weight-black" style="text-decoration: ;">
            ...
            <td class="text-xs-centre">
                ...
                <span v-if="props.item.change_type==='tag'">
                {{ props.item.change }}                    
                </span>
                <span v-else>

                <span v-for="(item, index) in getDiff(props.item.description, props.item.change)" :key="index">
                    <span v-if="item[0]=='-1'" style="text-decoration: line-through;">{{item[1]}}</span>
                    <span v-else-if="item[0]=='1'" style="text-decoration: underline;">{{item[1]}}</span>
                    <span v-else-if="item[0]=='0'" style="">{{item[1]}}</span>
                </span>
...
export default {
    data(){
        return {
            headers:[
                ...
                {text: 'Description', value: 'description', width: '37.5%'},
                // {text: 'Upvotes', value: 'upvotes'},
                // {text: 'Downvotes', value: 'downvotes'},
                // {text: 'Score', value: 'score'},
                {text: 'Change', value: 'change', width: '37.5%'},
                {text: 'Score', value: 'score_2', align:'center',width: '15%'},
            ],
            tags:[
                {tag:'Bewbs', description:'', upvotes:12, downvotes:2,score:12-2, like:true, change:"Some awesome bewbs everywhere", change_type:'description'},
                {tag:'Chocolate', change:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",change_type:'description', description:'Awesome choco pancakes! Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', upvotes:60, downvotes:13, score:60-13},
                {tag:'Ice Cream', description:'Epic Ice Cream!', upvotes:120, downvotes:40, dislike:true, change:"Ice_Cream!",change_type:'tag', score:120-40,},
                {tag:'Cakes', description:'Black fores cakes!', upvotes:19, downvotes:28, change:"Cakezzz!",change_type:'tag', score:19-28},
            ],
            search:'',
            pagination: {
                rowsPerPage: 50,
    ...
    methods:{
        ...
        getDiff(a,b){
            var diff = this.dmp.diff_main(a, b);
